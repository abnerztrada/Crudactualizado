...
require_once('../forms/segmento.php');
global $DB, $OUTPUT, $PAGE;

$PAGE->set_url('/blocks/inicial/vistas/create_segmento.php');
...
$editurl = new moodle_url('/blocks/inicial/vistas/create_segmento.php');
